...
| Semi-structured | VARIANT stays JSON in Arrow; typed ARRAY/struct need account `ENABLE_STRUCTURED_TYPES_IN_CLIENT_RESPONSE` — see [Query §ADBC](../13_rsnowflake_query/index.qmd#sec-adbc-semistructured) |
