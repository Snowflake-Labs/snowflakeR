...
| Semi-structured | VARIANT stays JSON in Arrow; typed ARRAY/struct need account `ENABLE_STRUCTURED_TYPES_IN_CLIENT_RESPONSE` — see [Feature Engineering §ADBC](../17a_feature_engineering_with_r/index.qmd#sec-adbc-semistructured) |
