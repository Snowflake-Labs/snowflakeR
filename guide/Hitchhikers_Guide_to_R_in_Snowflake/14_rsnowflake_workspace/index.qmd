...
| 2 | Python (optional) | Verify EAI enabled in Snowsight |
...
| Build time | Requires **Go compiler** + EAI for module downloads (~2 min cold) |
| Bulk writes | `upload_method = "auto"` may prefer **Snowpark** `write_pandas` in Workspace (~10× faster than literal INSERT for medium tables) |
