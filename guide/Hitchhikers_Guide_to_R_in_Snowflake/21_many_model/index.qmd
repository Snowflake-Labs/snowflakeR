...
Primary reference: [many-model-howto vignette (HTML)](../appendices/H_package_vignettes/index.qmd#sec-snowflaker) or `vignette("many-model-howto", package = "snowflakeR")` after install.
