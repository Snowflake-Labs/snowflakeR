...
subtitle: "snowflaker_*.yaml and tarball installs"
---
...
## Tarballs (required for snowflakeR / RSnowflake in prod) {#sec-tarballs}

::: {.callout-warning}
**Never compile snowflakeR or RSnowflake from source in Workspace.** Build tarballs locally (~10 seconds) and reference URLs or committed `.tar.gz` files.
:::
