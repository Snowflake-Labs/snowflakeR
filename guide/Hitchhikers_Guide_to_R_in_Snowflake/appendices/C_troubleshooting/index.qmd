...
| Issue | Symptom | Fix |
|-------|---------|-----|
| `sfnb_setup` not found | ImportError | Add `/filesystem/<hash>/snowflakeR/inst/notebooks` to `sys.path` ([Bootstrap](../../06_workspace_bootstrap/index.qmd)) |
...
## RSnowflake / SQL API {#sec-sql-api}
...
| Resource | Link |
|----------|------|
| Package issues | [snowflakeR](https://github.com/Snowflake-Labs/snowflakeR/issues), [RSnowflake](https://github.com/Snowflake-Labs/RSnowflake/issues) |
