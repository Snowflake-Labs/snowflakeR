...
| **Container compute** | SPCS — Docker workloads in-account | Inference, custom R, parallel workers |
...
- `collect()` in dbplyr pulls result sets **to your R session** — minimize data movement for large results; aggregate in SQL first.
...
**Further reading:** [About Snowflake Notebooks in Workspaces](https://docs.snowflake.com/en/user-guide/ui-snowsight/notebooks-in-workspaces)
...
| **Model Registry** | Versioned models, deployment, lineage | `snowflakeR` |
...
| RSnowflake | SQL over **SQL REST API** (+ optional ADBC) |
