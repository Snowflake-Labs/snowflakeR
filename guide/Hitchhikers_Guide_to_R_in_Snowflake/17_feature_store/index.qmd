...
For **end-to-end training export** (scalar-wide ASOF → three ARRAY/VECTOR packs, ARRAY-native views, OBJECT flattening, Python decode), use the pipeline table in [RSnowflake Query §End-to-end pipelines](../13_rsnowflake_query/index.qmd#sec-e2e-pipelines) (Pipelines A–E).
