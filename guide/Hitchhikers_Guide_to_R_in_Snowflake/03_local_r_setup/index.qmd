...
| **[RStudio, Posit & VS Code](../04_rstudio_posit_vscode/index.qmd)** | Per-IDE settings, Snowflake VS Code extension, **RSnowflake vs `odbc`**, Posit Native App — assumes install/auth from here |
:::
