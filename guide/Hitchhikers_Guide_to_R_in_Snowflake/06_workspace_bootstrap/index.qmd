...
![Python bootstrap cell with setup_notebook() in a connected notebook](../_images/06-bootstrap-cell.png){fig-alt="Workspace notebook Python cell calling setup_notebook with snowflakeR and RSnowflake packages" width=85%}
