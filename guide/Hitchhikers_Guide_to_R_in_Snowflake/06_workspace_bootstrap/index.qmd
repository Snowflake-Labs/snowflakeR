...
![Workspace notebook ready for Python bootstrap cell](../_images/06-bootstrap-cell.png){fig-alt="Workspace notebook editor where the setup_notebook Python bootstrap cell runs" width=85%}
