...
![Connect session settings — role, warehouse, external access](../_images/07-eai-toggle.png){fig-alt="Workspace notebook Connect control for role, warehouse, and external access settings" width=85%}
