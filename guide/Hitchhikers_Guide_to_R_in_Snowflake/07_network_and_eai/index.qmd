...
![Notebook toolbar before session attach — use Connected → Edit → External Access after connecting](../_images/07-eai-toggle.png){fig-alt="Workspace notebook with bootstrap cell and Connect control before compute session starts; enable External Access via Connected then Edit once connected" width=85%}
