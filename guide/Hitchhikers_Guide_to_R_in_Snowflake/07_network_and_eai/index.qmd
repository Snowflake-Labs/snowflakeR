...
![Connect control — attach notebook to a compute service](../_images/07-eai-toggle.png){fig-alt="Workspace notebook Connect button starting a session before role and warehouse are selected" width=85%}
