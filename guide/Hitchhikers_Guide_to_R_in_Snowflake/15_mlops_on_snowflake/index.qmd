...
::: {.callout-important}
See [Introduction](../00_introduction/index.qmd#sec-disclaimers) — snowflakeR is a community project, not officially supported by Snowflake.
:::
...
| PMML / ONNX conversion | Many R models don't convert cleanly |
