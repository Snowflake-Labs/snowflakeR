...
**RSnowflake** does not use JDBC or ODBC. It speaks to Snowflake through the **SQL API** — HTTPS REST endpoints that submit SQL and return results as JSON (or Arrow with ADBC).
...
| **Ecosystem maturity** | Newer | Decades of tooling |
...
For **large bulk reads**, RSnowflake optionally uses **ADBC** (Arrow Database Connectivity):
