...
The accompanying \textbf{reference notebooks} ship in snowflakeR:
\texttt{inst/notebooks/workspace\_parallel\_spcs\_setup.ipynb} and
\texttt{workspace\_parallel\_spcs\_demo.ipynb}. The code snippets below
follow that pattern. Lines marked \texttt{\#\#\ ADAPT} are the parts you
replace for your own data and models.
...
\item
  \textbf{Reference notebooks}:
  \texttt{inst/notebooks/workspace\_parallel\_spcs\_setup.ipynb},
  \texttt{workspace\_parallel\_spcs\_demo.ipynb} contains the complete
  runnable demo with configs, deploy scripts, and tests.
\item
